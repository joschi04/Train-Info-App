...
var DateAndTimePage = (function () {
    function DateAndTimePage(nav, localStorage) {
        this.nav = nav;
        this.localStorage = localStorage;
        var d = new Date();
        this.date = d.toLocaleDateString();
    }
    DateAndTimePage.prototype.openLocationPage = function () {
        // navigate to the new page if it is not the current page
        this.nav.setRoot(location_1.LocationPage);
    };
    DateAndTimePage = __decorate([
...
exports.DateAndTimePage = DateAndTimePage;
